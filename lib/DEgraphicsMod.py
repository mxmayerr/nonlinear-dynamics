...
class DEGraphWin(tk.Canvas):
    ...
    def setAutoFlush(self, autoflush):
        '''Sets autoflush to True or False'''
        self.autoflush = autoflush
...
class IntEntry(Entry):
    ...
    # redraw and undraw functions
    def redraw(self, win):
        '''redraw the entry in the window'''
        self._draw(win, self.config)
        # widgets isnt an opject
        win._widgets.append(self)
        
    
    def undraw(self):
        '''undraw the entry'''
        self._undraw()
        self._window._widgets.remove(self)
...
class Button:
    ...
    def setCaptionFace(self, font):
        '''Sets the font face of the button caption to font'''
        self.caption.setFace(font)
    
    # set style of caption
    def setCaptionStyle(self, style):
        '''Sets the style of the button caption to style'''
        self.caption.setStyle(style)
